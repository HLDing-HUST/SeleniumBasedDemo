    ...
    if name == "chromedriver":
        ...
        if found_geckodriver or url_request.ok:
            ...
            print("\nCould not find the specified geckodriver "
                "version to download!")
            print("\nPlease enter the version number in the following format!")
            print("\nv0.31.0\tv0.30.0\tv0.29.1\tv0.29.0 ...!\n")
            raise Exception(
                "\nCould not find the specified geckodriver "
                "version to download!\n"
            )
